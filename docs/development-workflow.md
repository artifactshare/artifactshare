...
- `pr:ready` requires a clean worktree, a Draft for the current branch targeting `main`, a pushed local `HEAD`, a sanitized task-usage report whose generated block is present in the PR body, and successful required checks.
