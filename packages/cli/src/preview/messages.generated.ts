...
export const PREVIEW_MESSAGES = {
  ...
  ja: {
    ...
    'preview.emptyHint':
      '気になる要素をクリックして注釈。リンクを操作したいときは右下のトグルで注釈モードを OFF',
    ...
    'preview.reopen': '差し戻す',
    'preview.reopenNote':
      '差し戻した注釈は、再度依頼するまでエージェントには届きません',
    ...
    'preview.orphanNoticeOne':
      'ページが大きく変わったため {n} 件の注釈が対象を見失いました',
    'preview.orphanNoticeOther':
      'ページが大きく変わったため {n} 件の注釈が対象を見失いました',
    ...
    'preview.add': '追加',
    'preview.corruptNotice':
      '保存済みの注釈の一部を読み込めませんでした。壊れたファイルは退避済みです',
