...
| `login` / `logout` / `whoami`                                      | Sign in, remove a saved local credential, and check who you are                                                                                                           |
