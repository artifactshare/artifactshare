...
import type { Route } from './+types/ja.guides.workspace-admin'

export function loader() {
  return getWorkspaceRoleGuideContent('admin', 'ja')
}
export function meta({ loaderData }: Route.MetaArgs) {
  return workspaceRoleGuideMeta('admin', loaderData?.locale ?? 'ja')
}
export default function JapaneseWorkspaceAdminGuide({
  loaderData,
