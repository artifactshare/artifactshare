...
export function recentShareableAccessPredicate(
  ...
  const containerId = sql.ref(`${containerAlias}.id`)
  const viewerUserId = sql.ref(`${viewerAlias}.viewer_user_id`)
