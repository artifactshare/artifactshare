...
Free workspaces can now choose link sharing for each file. Anyone with the share link can view the file without signing in to Artifact Share. Expiration works the same as on Plus: the workspace default is 30 days, and on Free no expiration is available without changing any setting.
