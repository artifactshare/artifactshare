...
function InputGroup({ className, ...props }: React.ComponentProps<'div'>) {
  // The input group intentionally joins its controls into one field.
  return (
    <div
...
function focusSiblingInput(
  ...
  next?.parentElement?.querySelector('input')?.focus()
}
...
function InputGroupAddon({
  ...
  return (
    <div
      ...
      onClick={(e) =>
        focusSiblingInput(e.target as HTMLElement, e.currentTarget)
      }
      onKeyDown={(e) => {
